...
# {'首页': 'http://www.ailab.cn/', '人工智能动态': 'http://ai.ailab.cn/', '大数据': 'http://bigdata.ailab.cn/', '智能机器人': 'http://robot.ailab.cn/', '无人机': 'http://uav.ailab.cn/', 
#'云计算': 'http://cloud.ailab.cn/', '机器学习': 'http://ml.ailab.cn/', '物联网': 'http://iot.ailab.cn/', '展会动态': 'http://www.ailab.cn/zhanhui.php'}
# print(web)
web['物联网']='http://iot.ailab.cn/'
for key in web:
